...
export function updateAppStats(stats, summary, serviceBindings, environmentVariables) {
  return { type: UPDATE_APP_STATS, stats, summary, serviceBindings, environmentVariables }
}
