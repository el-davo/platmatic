...
export function connectToLogWebsocket(instance: Instance, cfInfo: controllerInfo, app) {
	return new Promise((resolve, reject) => {
		let ws = new WebSocket(`${cfInfo.doppler_logging_endpoint}/apps/${app.metadata.guid}/stream`, {
			headers: {
